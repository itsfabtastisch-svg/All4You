...
DBG-Version: `ALL4YOU-ROUTER-V5.3-VISUAL-HERO-ICONS`
...
- Sichtbare DBG-Version: `ALL4YOU-ROUTER-V5.3-VISUAL-HERO-ICONS`
...
## v5.2 Roller Distance Demo

- Rollerabholservice bekommt eine echte Demo-Distanzmessung.
- Abholort und Zielort werden über OpenStreetMap/Nominatim gesucht.
- Fahrstrecke und Fahrzeit werden über OSRM Demo-Routing berechnet.
- Werte werden in der Anfrage gespeichert:
  - Distanz
  - Fahrzeit
  - Berechnungsanbieter
  - gefundene Adresse für Abholort/Zielort
- Kein Google Maps API-Key nötig.
- Für produktiven Dauerbetrieb später Google Maps Platform oder ein eigener/kommerzieller Routing-Anbieter empfohlen.
- Sichtbare DBG-Version: `ALL4YOU-ROUTER-V5.3-VISUAL-HERO-ICONS`
...
## v5.3 Visual Hero & Service Icon Upgrade

- Hero-Grafik oben rechts wurde komplett ersetzt.
- Neue, eigene SVG-Illustration im Stil der Kundenreferenz:
  - München-Skyline im Hintergrund
  - Rollertransport / Abschlepper
  - Anhänger
  - Möbel / Kartons
  - Reinigungseimer / Besen
- Service-Karten verwenden jetzt eigene hochwertige SVG-Illustrationen:
  - Rollerabholservice
  - Anhängervermietung
  - Entrümpelung
  - Reinigungsservice
