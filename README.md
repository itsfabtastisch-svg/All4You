## ALL4YOU-ROUTER-V5.6.1-TRAILER-CALENDAR-PICKER-DASHBOARD

- Anhänger-Assistent Schritt 1 erweitert um sichtbaren Kalenderstatus.
- Mietzeitraum zeigt jetzt zwei Monate als Kalenderübersicht.
- Kalenderstatus unterscheidet: frei, angefragt, belegt und nur auf Anfrage.
- Vergangene Zeiträume werden blockiert.
- Sonn- und Feiertage/Sondertage werden als „nur auf Anfrage“ markiert.
- Kalenderstatus und Kalenderhinweis werden in Zusammenfassung, Mailtext und Supabase-Details gespeichert.
- Keine Supabase-/Resend-/Dashboard-/Auth-/Cookie-/Impressum-/AGB-/Datenschutz-Änderungen.

# All4You Service München

## ALL4YOU-ROUTER-V5.6.1-TRAILER-CALENDAR-PICKER-DASHBOARD

- Footer-Kontaktnummer auf `01511 5417411` aktualisiert.
- Impressum, Datenschutzerklärung, AGB, Cookie-Banner und Wizard-Logik bleiben unverändert.
- Keine Supabase-/Resend-/Dashboard-/Auth-/Formular-Änderungen.
- Sichtbare DBG-Version: `ALL4YOU-ROUTER-V5.6.1-TRAILER-CALENDAR-PICKER-DASHBOARD`


DBG-Version: `ALL4YOU-ROUTER-V5.6.1-TRAILER-CALENDAR-PICKER-DASHBOARD`

## v5.5.4 Datenschutz exakt

- Datenschutzerklärung exakt nach dem gelieferten finalen Text eingepflegt.
- Zusätzliche Datenschutz-Hinweis-/Filler-Blöcke entfernt.
- V5.5.3 Weiter-Button-Fix bleibt enthalten.
- Keine Supabase-/Resend-/Dashboard-/Auth-Änderungen.
...
- Cookie-Consent-Banner mit Buttons „Alle akzeptieren“, „Nur notwendige“ und „Einstellungen“ ergänzt.
- Cookie-Einstellungen im Footer ergänzt, damit Besucher ihre Auswahl später ändern können.
- Google Analytics wird technisch nur nach Zustimmung vorbereitet; ohne Measurement-ID wird kein Google-Analytics-Script geladen.
- Wizard-Button-Hard-Fix aus V5.5.5 bleibt enthalten.
...
- Anhänger-Assistent Schritt 1 wurde auf einen echten klickbaren Zeitraum-Kalender umgestellt.
- Die sichtbaren Datumsfelder Mietbeginn/Mietende wurden entfernt; der Kunde wählt den Zeitraum über „Zeitraum wählen“ direkt im Kalender.
- Mietdauer, Mietpreis und Kalenderstatus werden aus dem gewählten Zeitraum berechnet.
- Anhänger-Kalenderregeln können im Mitarbeiter-Dashboard vorbereitet werden.
- Supabase-Tabelle `trailer_calendar_rules` wird über die SQL-Datei `supabase/sql/trailer_calendar_rules.sql` bereitgestellt.
- Ohne eingerichtete Tabelle fällt der öffentliche Kalender sauber auf Standardlogik zurück: frei/anfragbar, Sonntage/Feiertage nur auf Anfrage.
- Keine Änderungen an Impressum, Datenschutz, AGB, Cookie-Banner, Resend, Auth oder bestehenden Anfrage-Tabellen.
