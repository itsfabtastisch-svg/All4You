...
.op-job-card.job-in_arbeit,
.op-job-card.job-in_progress {
  border-color: rgba(10,169,155,.50);
  background: linear-gradient(135deg, #e8fbf7, #fff);
}
.op-job-card.job-in_bearbeitung {
  border-color: rgba(83,173,255,.32);
...
.op-job-status.job-in_arbeit, .op-job-status.job-in_progress { background: #dff9f3; color: #056e66; }
.op-job-status.job-in_bearbeitung, .op-job-status.job-assigned { background: #eef7fa; color: #30546d; }
